...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-card { background: var(--surface); border: 1px solid var(--border); border-radius: 16px; padding: 40px; width: 100%; max-width: 420px; box-shadow: 0 8px 32px rgba(0,0,0,.08); }
        ...
        .alert-error { background: var(--rose-soft); color: var(--rose); border: 1px solid var(--rose); border-radius: 8px; padding: 10px 14px; font-size: 13px; margin-bottom: 16px; }
        ...
        .back-link { position: fixed; top: 16px; left: 16px; font-size: 13px; color: var(--text-muted); display: flex; align-items: center; gap: 5px; }
...
<div class="auth-card">
    ...
    <h1>Welcome back</h1>
    <p class="auth-sub">Sign in to your Careflow account</p>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="you@clinic.com">
